...
NSString * const kTwitterConsumerKey = @"YptpjImPVPRFgWiAwK8eDOvwH";
NSString * const kTwitterConsumerSecret = @"TKO9pU6NLam4izuZzkwFMBk6zkHkKr86tVlSAbfPCLysJX7GwG";
...
- (void) loginWithCompletetion: (void (^) (User* user, NSError * error))completion {
    ...
    [self fetchRequestTokenWithPath:@"oauth/request_token" method:@"GET" callbackURL:[NSURL URLWithString:@"cptwitter2://oath"] scope:nil success:^(BDBOAuthToken* requestToken) {
